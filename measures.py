...
print("Q1 : How many allocations are generated by each algorithm on average? \n"
      " And what about the fraction of problems in which a unique allocation is generated?")
...
for N in range(Nmin, Nmax+1, 2):
    ...
    OS_frac_uniq.append(round(100.*os_n_frac_uniq/len(OS_Number_of_allocations_L), 1))
    ...
    RS_frac_uniq.append(round(100.*rs_n_frac_uniq/len(RS_Number_of_allocations_L), 1))
    ...
    BU_frac_uniq.append(round(100.*bu_n_frac_uniq/len(BU_Number_of_allocations_L), 1))
    ...
    TR_frac_uniq.append(round(100.*tr_n_frac_uniq/len(TR_Number_of_allocations_L), 1))
